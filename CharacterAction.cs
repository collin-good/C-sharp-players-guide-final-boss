...
class Punch : CharacterAction { public Punch() : base("Punch", "punches", new(1, 1)) { } }
...
class QuickShot : CharacterAction { public QuickShot() : base("Quick Shot", "quick shots", new AttackData(3, 0.75f)) { } }
